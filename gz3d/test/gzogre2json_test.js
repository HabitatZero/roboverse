...
`;
      ...
      const pass = o2j.materialObj[0]["Beer/Diffuse"].technique.pass;
      ...
      const textUnit = pass.texture_unit;
...
`;
      ...
      const pass = o2j.materialObj[0].many_arrays.technique.pass;
      expect(pass).toBeDefined();
      ...
      expect(pass.texture_unit.alpha_op_ex).toEqual([
        "source1",
        "src_manual",
        "src_current",
        "0.5",
      ...
      const mat = o2j.materials.many_arrays;
      expect(mat).toBeDefined();
...
`;
      ...
      expect(o2j.materialObj[0]["Dumpster/Diffuse"]).toBeDefined();

      expect(o2j.materialObj[1]["Dumpster/Specular"]).toBeDefined();
...
`;
      ...
      // Check refs
      expect(o2j.materialObj[0]["Gazebo/Gray"]).toBeDefined();

      expect(o2j.materialObj[0]["Gazebo/Gray"]).toEqual({});
    });
  });
