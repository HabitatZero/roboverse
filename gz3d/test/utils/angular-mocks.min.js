!(function (e, t, n) {
  ...
  function s(e, r, o) {
    ...
    function s(e, i, s, c, u, $, p) {
      ...
      if (w && w.match(e, i)) {
        ...
        if ((l.shift(), w.response)) return void d.push(v(w));
        E = !0;
      }
      for (var T, D = -1; (T = f[++D]); )
        if (T.match(e, i, s, u || {})) {
          if (T.response) (o ? o.defer : h)(v(T));
          else {
            if (!T.passThrough) throw new Error("No response defined !");
            r(e, i, s, c, u, $, p);
          }
          return;
        }
    ...
    return (
      ...
      u("when"),
      (s.expect = function (e, t, n, r) {
        var o = new c(e, t, n, r),
          s = {
            respond: function (e, t, n, r) {
              return (o.response = i(e, t, n, r)), s;
            },
          };
        return l.push(o), s;
      }),
      u("expect"),
      (s.flush = function (n, r) {
  ...
  function c(e, n, r, o) {
    (this.data = r),
      ...
      (this.matchUrl = function (e) {
        return (
          !n ||
          (t.isFunction(n.test) ? n.test(e) : t.isFunction(n) ? n(e) : n == e)
        );
      }),
  ...
  (t.mock = {}),
    ...
    (t.mock.$Browser = function () {
      ...
      (this.isMock = !0),
        ...
        (e.onUrlChange = function (t) {
          return (
            e.pollFns.push(function () {
              (e.$$lastUrl === e.$$url && e.$$state === e.$$lastState) ||
                ((e.$$lastUrl = e.$$url),
                (e.$$lastState = e.$$state),
                t(e.$$url, e.$$state));
            }),
        ...
        (e.defer.flush = function (n) {
          ...
          for (; e.deferredFns.length && e.deferredFns[0].time <= e.defer.now; )
    ...
    (t.mock.$Browser.prototype = {
      ...
      url: function (e, n, r) {
        return (
          t.isUndefined(r) && (r = null),
          e ? ((this.$$url = e), (this.$$state = t.copy(r)), this) : this.$$url
        );
      },
      state: function () {
        return this.$$state;
      ...
      cookies: function (e, n) {
        if (!e)
          return (
            t.equals(this.cookieHash, this.lastCookieHash) ||
          ...
          return (
            (c.cancel = function (e) {
              ...
              return (
                ...
                r !== n &&
                  (o[r].deferred.reject("canceled"), o.splice(r, 1), !0)
              );
            }),
            (c.flush = function (e) {
  ...
  var u = /^(\d{4})-?(\d\d)-?(\d\d)(?:T(\d\d)(?:\:?(\d\d)(?:\:?(\d\d)(?:\.(\d{3}))?)?)?(Z|([+-])(\d\d):?(\d\d)))?$/;
  if (
    ((t.mock.TzDate = function (e, n) {
      ...
      (o.offsetDiff = 60 * c * 1e3 - 1e3 * e * 60 * 60),
        ...
        (o.getMonth = function () {
          return o.date.getMonth();
        }),
        (o.getDate = function () {
          return o.date.getDate();
        }),
        (o.getHours = function () {
          return o.date.getHours();
        }),
        (o.getMinutes = function () {
          return o.date.getMinutes();
        }),
        (o.getSeconds = function () {
          return o.date.getSeconds();
        }),
        (o.getMilliseconds = function () {
          return o.date.getMilliseconds();
        }),
        (o.getTimezoneOffset = function () {
          return 60 * e;
        }),
        (o.getUTCFullYear = function () {
          return o.origDate.getUTCFullYear();
        }),
        (o.getUTCMonth = function () {
          return o.origDate.getUTCMonth();
        }),
        (o.getUTCDate = function () {
          return o.origDate.getUTCDate();
        }),
        (o.getUTCHours = function () {
          return o.origDate.getUTCHours();
        }),
        (o.getUTCMinutes = function () {
          return o.origDate.getUTCMinutes();
        }),
        (o.getUTCSeconds = function () {
          return o.origDate.getUTCSeconds();
        }),
        (o.getUTCMilliseconds = function () {
          return o.origDate.getUTCMilliseconds();
        }),
        (o.getDay = function () {
          return o.date.getDay();
        }),
        o.toISOString &&
          (o.toISOString = function () {
            return (
              i(o.origDate.getUTCFullYear(), 4) +
              "-" +
              i(o.origDate.getUTCMonth() + 1, 2) +
              "-" +
              i(o.origDate.getUTCDate(), 2) +
              "T" +
              ...
              "." +
              i(o.origDate.getUTCMilliseconds(), 3) +
              "Z"
            );
          });
      var a = [
      ...
      return (
        t.forEach(a, function (e) {
          o[e] = function () {
            throw new Error(
              "Method '" + e + "' is not implemented in the TzDate mock"
            );
          };
        }),
        o
        ...
        return (
          t.isElement(e)
            ...
            ? ((o = []),
              ...
              (o = "[ " + o.join(", ") + " ]"))
            : (o = t.isObject(e)
                ? t.isFunction(e.$eval) && t.isFunction(e.$apply)
                  ? r(e)
                  : e instanceof Error
    ...
    (e.beforeEach || e.setup)(function () {
      ...
      (e.afterEach || e.teardown)(function () {
        var e = f.$injector;
        t.forEach(f.$modules, function (e) {
