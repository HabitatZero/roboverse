describe("Gui tests", function () {
  ...
  describe("jQuery interactions", function () {
    it("check GUI events", function () {
      ...
      expect(globalEmitter.listeners("manipulation_mode").length).toEqual(1);
      expect(globalEmitter.listeners("toggle_notifications").length).toEqual(1);
      expect(globalEmitter.listeners("show_orbit_indicator").length).toEqual(1);
