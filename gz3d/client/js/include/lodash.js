...
/**
 * Used to detect hot functions by number of calls within a span of
 * milliseconds.
 */
const HOT_COUNT = 800;
const HOT_SPAN = 16;
 ...
 * Used to match
 * [ES template
 * delimiters](http://ecma-international.org/ecma-262/7.0/#sec-template-literal-lexical-components).
 */
...
const rsMisc = "[^" + rsAstralRange + rsBreakRange + rsDigits + rsDingbatRange +
...
function baseIndexOf(array, value, fromIndex) {
  return value === value ? strictIndexOf(array, value, fromIndex)
...
function basePropertyOf(object) {
  return function(key) { return object == null ? undefined : object[key]; };
}
...
function baseReduce(collection, iteratee, accumulator, initAccum, eachFunc) {
  eachFunc(collection, function(value, index, collection) {
    accumulator = initAccum ? ((initAccum = false), value)
...
/**
 * The base implementation of `_.toPairs` and `_.toPairsIn` which creates an
 * array of key-value pairs for `object` corresponding to the property names of
 * `props`.
 *
 * @private
 * @param {Object} object The object to query.
...
function baseToPairs(object, props) {
  return arrayMap(props, function(key) { return [ key, object[key] ]; });
}
...
/**
 * Used by `_.template` to escape characters for inclusion in compiled string
 * literals.
 *
 * @private
 * @param {string} chr The matched character to escape.
...
function setToArray(set) {
  ...
  set.forEach(function(value) { result[++index] = value; });
  return result;
}
...
const runInContext = function runInContext(context) {
  context = context == null ? root
                            : _.defaults(root.Object(), context,
   ...
   * `keys`, `keysIn`, `map`, `mapKeys`, `mapValues`, `matches`,
   * `matchesProperty`, `memoize`, `merge`, `mergeWith`, `method`, `methodOf`,
   * `mixin`, `negate`, `nthArg`, `omit`, `omitBy`, `once`, `orderBy`, `over`,
   * `overArgs`, `overEvery`, `overSome`, `partial`, `partialRight`,
   * `partition`, `pick`, `pickBy`, `plant`, `property`, `propertyOf`, `pull`,
   * `pullAll`, `pullAllBy`, `pullAllWith`, `pullAt`, `push`, `range`,
   * `rangeRight`, `rearg`, `reject`, `remove`, `rest`, `reverse`, `sampleSize`,
   * `set`, `setWith`, `shuffle`, `slice`, `sort`, `sortBy`, `splice`, `spread`,
   * `tail`, `take`, `takeRight`, `takeRightWhile`, `takeWhile`, `tap`,
   * `throttle`, `thru`, `toArray`, `toPairs`, `toPairsIn`, `toPath`,
   * `toPlainObject`, `transform`, `unary`, `union`, `unionBy`, `unionWith`,
   * `uniq`, `uniqBy`, `uniqWith`, `unset`, `unshift`, `unzip`, `unzipWith`,
   * `update`, `updateWith`, `values`, `valuesIn`, `without`, `wrap`, `xor`,
   * `xorBy`, `xorWith`, `zip`, `zipObject`, `zipObjectDeep`, and `zipWith`
   *
   ...
   * `findLastIndex`, `findLastKey`, `first`, `floor`, `forEach`,
   * `forEachRight`, `forIn`, `forInRight`, `forOwn`, `forOwnRight`, `get`,
   * `gt`, `gte`, `has`, `hasIn`, `head`, `identity`, `includes`, `indexOf`,
   * `inRange`, `invoke`, `isArguments`, `isArray`, `isArrayBuffer`,
   * `isArrayLike`, `isArrayLikeObject`, `isBoolean`, `isBuffer`, `isDate`,
   * `isElement`, `isEmpty`, `isEqual`, `isEqualWith`, `isError`, `isFinite`,
   * `isFunction`, `isInteger`, `isLength`, `isMap`, `isMatch`, `isMatchWith`,
   * `isNaN`, `isNative`, `isNil`, `isNull`, `isNumber`, `isObject`,
   * `isObjectLike`, `isPlainObject`, `isRegExp`, `isSafeInteger`, `isSet`,
   * `isString`, `isUndefined`, `isTypedArray`, `isWeakMap`, `isWeakSet`,
   * `join`, `kebabCase`, `last`, `lastIndexOf`, `lowerCase`, `lowerFirst`,
   * `lt`, `lte`, `max`, `maxBy`, `mean`, `meanBy`, `min`, `minBy`, `multiply`,
   * `noConflict`, `noop`, `now`, `nth`, `pad`, `padEnd`, `padStart`,
   * `parseInt`, `pop`, `random`, `reduce`, `reduceRight`, `repeat`, `result`,
   * `round`, `runInContext`, `sample`, `shift`, `size`, `snakeCase`, `some`,
   * `sortedIndex`, `sortedIndexBy`, `sortedLastIndex`, `sortedLastIndexBy`,
   * `startCase`, `startsWith`, `stubArray`, `stubFalse`, `stubObject`,
   * `stubString`, `stubTrue`, `subtract`, `sum`, `sumBy`, `template`, `times`,
   * `toFinite`, `toInteger`, `toJSON`, `toLength`, `toLower`, `toNumber`,
   * `toSafeInteger`, `toString`, `toUpper`, `trim`, `trimEnd`, `trimStart`,
   * `truncate`, `unescape`, `uniqueId`, `upperCase`, `upperFirst`, `value`, and
   * `words`
   *
   * @name _
   * @constructor
  ...
  /**
   * Creates an array of the enumerable property names of the array-like
   * `value`.
   *
   * @private
      ...
      if ((inherited || hasOwnProperty.call(value, key)) &&
          !(skipIndexes &&
            ...
            (key == "length" ||
             ...
             (isType && (key == "buffer" || key == "byteLength" ||
                         key == "byteOffset")) ||
  ...
  /**
   * Assigns `value` to `key` of `object` if the existing value is not
   * equivalent using
  ...
  /**
   * The base implementation of `_.assignIn` without support for multiple
   * sources or `customizer` functions.
   *
   * @private
   * @param {Object} object The destination object.
   * @param {Object} source The source object.
   ...
   * @param {Object} [stack] Tracks traversed objects and their clone
   *     counterparts.
  ...
  function baseClone(value, bitmask, customizer, key, object, stack) {
    ...
    if (customizer) {
      result =
          object ? customizer(value, key, object, stack) : customizer(value);
    }
    if (result !== undefined) {
      return result;
    }
    ...
    if (isArr) {
      ...
      if (tag == objectTag || tag == argsTag || (isFunc && !object)) {
        ...
        if (!isDeep) {
          return isFlat ? copySymbolsIn(value, baseAssignIn(result, value))
  ...
  /**
   * The base implementation of `_.forEach` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Array|Object} collection The collection to iterate over.
  ...
  /**
   * The base implementation of `_.forEachRight` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Array|Object} collection The collection to iterate over.
  ...
  /**
   * The base implementation of `_.every` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Array|Object} collection The collection to iterate over.
  ...
  function baseExtremum(array, iteratee, comparator) {
    ...
    while (++index < length) {
      ...
      if (current != null &&
          (computed === undefined ? current === current && !isSymbol(current)
  ...
  /**
   * The base implementation of `_.filter` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Array|Object} collection The collection to iterate over.
  ...
  /**
   * The base implementation of `_.flatten` with support for restricting
   * flattening.
   *
   * @private
   * @param {Array} array The array to flatten.
   * @param {number} depth The maximum recursion depth.
   * @param {boolean} [predicate=isFlattenable] The function invoked per
   *     iteration.
   * @param {boolean} [isStrict] Restrict to values that pass `predicate`
   *     checks.
  ...
  /**
   * The base implementation of `_.forOwnRight` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Object} object The object to iterate over.
  ...
  function baseFunctions(object, props) {
    return arrayFilter(props,
                       function(key) { return isFunction(object[key]); });
  }
  ...
  /**
   * The base implementation of `getTag` without fallbacks for buggy
   * environments.
   *
   * @private
   * @param {*} value The value to query.
   ...
   * @returns {boolean} Returns `true` if `number` is in the range, else
   *     `false`.
   */
  ...
  function baseIntersection(arrays, iteratee, comparator) {
    ...
    outer: while (++index < length && result.length < maxLength) {
      ...
      value = comparator || value !== 0 ? value : 0;
      if (!(seen ? cacheHas(seen, computed)
                 : includes(result, computed, comparator))) {
        othIndex = othLength;
        while (--othIndex) {
          const cache = caches[othIndex];
          if (!(cache ? cacheHas(cache, computed)
   ...
   * @private
   * @param {*} value The value to check.
   * @returns {boolean} Returns `true` if `value` is an array buffer, else
   *     `false`.
   */
   ...
   * @private
   * @param {*} value The value to check.
   * @returns {boolean} Returns `true` if `value` is a date object, else
   *     `false`.
   */
   ...
   * @param {number} bitmask The bitmask flags. See `baseIsEqual` for more
   *     details.
   * @param {Function} customizer The function to customize comparisons.
   * @param {Function} equalFunc The function to determine equivalents of
   *     values.
  ...
  function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc,
    ...
    if (isSameTag && !objIsObj) {
      ...
      return objIsArr || isTypedArray(object)
                 ? equalArrays(object, other, bitmask, customizer, equalFunc,
                               stack)
  ...
  /**
   * The base implementation of `_.isMatch` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Object} object The object to inspect.
   * @param {Object} source The object of property values to match.
   * @param {Array} matchData The property names, values, and compare flags to
   *     match.
   * @param {Function} [customizer] The function to customize comparisons.
  ...
  function baseIsMatch(object, source, matchData, customizer) {
    ...
    while (index--) {
      ...
      if (noCustomizer && data[2] ? data[1] !== object[data[0]]
                                  : !(data[0] in object)) {
        return false;
      }
    }
   ...
   * @private
   * @param {*} value The value to check.
   * @returns {boolean} Returns `true` if `value` is a typed array, else
   *     `false`.
   */
  ...
  function baseIteratee(value) {
    // Don't store the `typeof` result in a variable to avoid a JIT bug in
    // Safari 9. See https://bugs.webkit.org/show_bug.cgi?id=156034 for more
    // details.
    ...
    if (typeof value === "object") {
      return isArray(value) ? baseMatchesProperty(value[0], value[1])
                            : baseMatches(value);
    }
  ...
  /**
   * The base implementation of `_.keysIn` which doesn't treat sparse arrays as
   * dense.
   *
   * @private
   * @param {Object} object The object to query.
  ...
  function baseMerge(object, source, srcIndex, customizer, stack) {
    ...
    baseFor(source, function(srcValue, key) {
      if (isObject(srcValue)) {
        stack || (stack = new Stack());
        baseMergeDeep(object, source, key, srcIndex, baseMerge, customizer,
                      stack);
      } else {
        let newValue = customizer ? customizer(safeGet(object, key), srcValue,
                                               key + "", object, source, stack)
                                  : undefined;
  ...
  function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer,
    ...
    let newValue = customizer ? customizer(objValue, srcValue, key + "", object,
                                           source, stack)
                              : undefined;
  ...
  function baseOrderBy(collection, iteratees, orders) {
    let index = -1;
    iteratees = arrayMap(iteratees.length ? iteratees : [ identity ],
    ...
    return baseSortBy(
        result,
        function(object,
                 other) { return compareMultiple(object, other, orders); });
  }
  ...
  function basePick(object, paths) {
    return basePickBy(object, paths,
                      function(value, path) { return hasIn(object, path); });
  }

  /**
   * The base implementation of  `_.pickBy` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Object} object The source object.
  ...
  /**
   * The base implementation of `_.rest` which doesn't validate or coerce
   * arguments.
   *
   * @private
   * @param {Function} func The function to apply a rest parameter to.
   * @param {number} [start=func.length-1] The start position of the rest
   *     parameter.
   * @returns {Function} Returns the new function.
   */
  ...
  function baseSet(object, path, value, customizer) {
    ...
    while (nested != null && ++index < length) {
      ...
      if (index != lastIndex) {
        ...
        if (newValue === undefined) {
          newValue = isObject(objValue) ? objValue
  ...
  /**
   * The base implementation of `setToString` without support for hot loop
   * shorting.
   *
   * @private
  ...
  /**
   * The base implementation of `_.some` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Array|Object} collection The collection to iterate over.
  ...
  /**
   * The base implementation of `_.uniqBy` without support for iteratee
   * shorthands.
   *
   * @private
   * @param {Array} array The array to inspect.
  ...
  function baseWhile(array, predicate, isDrop, fromRight) {
    ...
    return isDrop ? baseSlice(array, fromRight ? 0 : index,
      ...
      while (++othIndex < length) {
        if (othIndex != index) {
          result[index] = baseDifference(
              result[index] || array, arrays[othIndex], iteratee, comparator);
        }
      }
    }
  ...
  /**
   * This base implementation of `_.zipObject` which assigns values using
   * `assignFunc`.
   *
   * @private
  ...
  /**
   * A simple wrapper around the global
   * [`clearTimeout`](https://mdn.io/clearTimeout).
   *
   * @private
   ...
   */
  const clearTimeout =
      ctxClearTimeout || function(id) { return root.clearTimeout(id); };
  ...
  function cloneTypedArray(typedArray, isDeep) {
    const buffer =
        isDeep ? cloneArrayBuffer(typedArray.buffer) : typedArray.buffer;
  ...
  function compareMultiple(object, other, orders) {
    ...
    // for `object` and `other`. See
    // https://github.com/jashkenas/underscore/pull/1247 for more details.
    //
  ...
  function copyObject(source, props, object, customizer) {
    ...
    while (++index < length) {
      ...
      let newValue =
          customizer ? customizer(object[key], source[key], key, object, source)
                     : undefined;
  ...
  function createCaseFirst(methodName) {
    return function(string) {
      ...
      const trailing =
          strSymbols ? castSlice(strSymbols, 1).join("") : string.slice(1);
  ...
  function createCurry(func, bitmask, arity) {
    ...
    function wrapper() {
      ...
      const holders = length < 3 && args[0] !== placeholder &&
      ...
      if (length < arity) {
        return createRecurry(func, bitmask, createHybrid, wrapper.placeholder,
                             undefined, args, holders, undefined, undefined,
                             arity - length);
      }
      const fn = this && this !== root && this instanceof wrapper ? Ctor : func;
  ...
  function createFind(findIndexFunc) {
    return function(collection, predicate, fromIndex) {
      ...
      return index > -1 ? iterable[iteratee ? collection[index] : index]
                        : undefined;
    };
  }
    ...
    return flatRest(function(funcs) {
      ...
      while (++index < length) {
        ...
        if (data && isLaziable(data[0]) &&
            data[1] == (WRAP_ARY_FLAG | WRAP_CURRY_FLAG | WRAP_PARTIAL_FLAG |
                        WRAP_REARG_FLAG) &&
            !data[4].length && data[9] == 1) {
          wrapper = wrapper[getFuncName(data[0])].apply(wrapper, data[3]);
        } else {
          wrapper = func.length == 1 && isLaziable(func) ? wrapper[funcName]()
                                                         : wrapper.thru(func);
        }
      }
      return function() {
   ...
   * @returns {Function} Returns the new wrapped function.
   */
  function createHybrid(func, bitmask, thisArg, partials, holders,
    ...
    function wrapper() {
      ...
      if (isCurried && length < arity) {
        ...
        return createRecurry(func, bitmask, createHybrid, wrapper.placeholder,
                             thisArg, args, newHolders, argPos, ary,
                             arity - length);
      }
  ...
  function createOver(arrayFunc) {
    return flatRest(function(iteratees) {
      ...
      return baseRest(function(args) {
        ...
        return arrayFunc(
            iteratees,
            function(iteratee) { return apply(iteratee, thisArg, args); });
      });
    });
  }
   ...
   * @returns {Function} Returns the new wrapped function.
   */
  function createRecurry(func, bitmask, wrapFunc, placeholder, thisArg,
   ...
   *
   * @private
   * @param {string} methodName The name of the `Math` method to use when
   *     rounding.
   ...
   * @returns {Function} Returns the new wrapped function.
   */
  function createWrap(func, bitmask, thisArg, partials, holders, argPos, ary,
                      arity) {
    const isBindKey = bitmask & WRAP_BIND_KEY_FLAG;
    ...
    } else if ((bitmask == WRAP_PARTIAL_FLAG ||
   ...
   * @returns {*} Returns the uncloned value or `undefined` to defer cloning to
   *     `_.cloneDeep`.
   */
  ...
  function equalObjects(object, other, bitmask, customizer, equalFunc, stack) {
    ...
    if (result && !skipCtor) {
      ...
      // equal.
      if (objCtor != othCtor && "constructor" in object &&
  ...
  /**
   * A simple wrapper around the global
   * [`setTimeout`](https://mdn.io/setTimeout).
   *
   * @private
   * @param {Function} func The function to delay.
   * @param {number} wait The number of milliseconds to delay invocation.
   ...
   */
  var setTimeout =
      ctxSetTimeout || function(func,
                                wait) { return root.setTimeout(func, wait); };
  ...
  /**
   * A specialized version of `_.shuffle` which mutates and sets the size of
   * `array`.
   *
   * @private
   * @param {Array} array The array to shuffle.
  ...
  var stringToPath = memoizeCapped(function(string) {
    ...
    string.replace(rePropName, function(match, number, quote, subString) {
      result.push(quote ? subString.replace(reEscapeChar, "$1")
                        : number || match);
    });
    return result;
  });
  ...
  function concat() {
    ...
    return arrayPush(isArray(array) ? copyArray(array) : [ array ],
                     baseFlatten(args, 1));
  }
   ...
   * values are determined by the first array. The iteratee is invoked with one
   * argument: (value).
   *
  ...
  function findLastIndex(array, predicate, fromIndex) {
    ...
    if (fromIndex !== undefined) {
      ...
      index = fromIndex < 0 ? nativeMax(length + index, 0)
  ...
  function lastIndexOf(array, value, fromIndex) {
    ...
    if (fromIndex !== undefined) {
      index = toInteger(fromIndex);
      index = index < 0 ? nativeMax(length + index, 0)
                        : nativeMin(index, length - 1);
    }
    return value === value ? strictLastIndexOf(array, value, index)
  ...
  const unionWith = baseRest(function(arrays) {
    let comparator = last(arrays);
    comparator = typeof comparator === "function" ? comparator : undefined;
    return baseUniq(baseFlatten(arrays, 1, isArrayLikeObject, true), undefined,
                    comparator);
  });
   ...
   * element is kept. The order of result values is determined by the order they
   * occur in the array.
   *
   * @static
   * @memberOf _
  ...
  function unzip(array) {
    ...
    return baseTimes(
        length,
        function(index) { return arrayMap(array, baseProperty(index)); });
  }
  ...
  function unzipWith(array, iteratee) {
    ...
    return arrayMap(
        result, function(group) { return apply(iteratee, undefined, group); });
  }
   ...
   * // => [1, 3]
   */
  const xor = baseRest(function(
      arrays) { return baseXor(arrayFilter(arrays, isArrayLikeObject)); });
  ...
  /**
   * Creates a `lodash` wrapper instance with explicit method chain sequences
   * enabled.
   *
   * @name chain
   * @memberOf _
  ...
  /**
   * Creates a clone of the chain sequence planting `value` as the wrapped
   * value.
   *
   * @name plant
   * @memberOf _
   ...
   * element. The iteratee is invoked with three arguments: (value, index|key,
  ...
  const invokeMap = baseRest(function(collection, path, args) {
    ...
    baseEach(collection, function(value) {
      result[++index] =
          isFunc ? apply(path, value, args) : baseInvoke(value, path, args);
    });
    return result;
  });
   ...
   * });
   * // => { 'a': { 'dir': 'left', 'code': 97 }, 'd': { 'dir': 'right', 'code':
   * 100 } }
   *
   * _.keyBy(array, 'dir');
   * // => { 'left': { 'dir': 'left', 'code': 97 }, 'right': { 'dir': 'right',
   * 'code': 100 } }
   */
  const keyBy = createAggregator(function(
      result, value, key) { baseAssignValue(result, key, value); });
   ...
   */
  const partition =
      createAggregator(function(result, value,
                                key) { result[key ? 0 : 1].push(value); },
                       function() {
                         return [ [], [] ];
                       });
  ...
  function reduce(collection, iteratee, accumulator) {
    ...
    return func(collection, getIteratee(iteratee, 4), accumulator, initAccum,
                baseEach);
  }
   ...
   * // => objects for [['barney', 34], ['barney', 36], ['fred', 40], ['fred',
   * 48]]
   */
   ...
   */
  const now = ctxNow || function() { return root.Date.now(); };
  ...
  function ary(func, n, guard) {
    ...
    return createWrap(func, WRAP_ARY_FLAG, undefined, undefined, undefined,
                      undefined, n);
  }
   ...
   *
   * **Note:** Unlike native `Function#bind`, this method doesn't set the
   ...
   *
   * **Note:** This method doesn't set the "length" property of curried
   * functions.
   *
   * @static
   * @memberOf _
  ...
  function curry(func, arity, guard) {
    ...
    const result = createWrap(func, WRAP_CURRY_FLAG, undefined, undefined,
                              undefined, undefined, undefined, arity);
  ...
  function curryRight(func, arity, guard) {
    arity = guard ? undefined : arity;
    const result = createWrap(func, WRAP_CURRY_RIGHT_FLAG, undefined, undefined,
                              undefined, undefined, undefined, arity);
  ...
  function debounce(func, wait, options) {
    ...
    if (isObject(options)) {
      ...
      maxWait =
          maxing ? nativeMax(toNumber(options.maxWait) || 0, wait) : maxWait;
    ...
    function remainingWait(time) {
      ...
      return maxing ? nativeMin(timeWaiting, maxWait - timeSinceLastInvoke)
                    : timeWaiting;
    }
   ...
   */
  const defer =
      baseRest(function(func, args) { return baseDelay(func, 1, args); });
   ...
   */
  const delay = baseRest(function(
      func, wait, args) { return baseDelay(func, toNumber(wait) || 0, args); });
  ...
  const rearg = flatRest(function(func, indexes) {
    return createWrap(func, WRAP_REARG_FLAG, undefined, undefined, undefined,
                      indexes);
  });
   ...
   * once every 5 minutes. var throttled = _.throttle(renewToken, 300000, {
   ...
   * is invoked to produce the cloned value. If `customizer` returns
   * `undefined`, cloning is handled by the method instead. The `customizer` is
   * invoked with up to four arguments; (value [, index|key, object, stack]).
   *
   * @static
   * @memberOf _
   * @since 4.0.0
  ...
  /**
   * This method is like `_.cloneWith` except that it recursively clones
   * `value`.
   *
   * @static
   * @memberOf _
   ...
   * // => false
   */
  const gte = createRelationalOperation(function(
      value, other) { return value >= other; });
   ...
   */
  var isArguments =
      baseIsArguments((function() { return arguments; })())
          ? baseIsArguments
          : function(value) {
   ...
   * jQuery-like collections are considered empty if they have a `length` of
   * `0`. Similarly, maps and sets are considered empty if they have a `size` of
   * `0`.
   *
   * @static
   * @memberOf _
  ...
  function isEmpty(value) {
    ...
    if (isArrayLike(value) &&
        (isArray(value) || typeof value === "string" ||
         typeof value.splice === "function" || isBuffer(value) ||
   ...
   * is invoked to compare values. If `customizer` returns `undefined`,
   * comparisons are handled by the method instead. The `customizer` is invoked
   * with up to six arguments: (objValue, othValue [, index|key, object, other,
   * stack]).
   *
   * @static
   * @memberOf _
   ...
   * is invoked to compare values. If `customizer` returns `undefined`,
   * comparisons are handled by the method instead. The `customizer` is invoked
   * with five arguments: (objValue, srcValue, index|key, object, source).
   *
   * @static
   * @memberOf _
   * @since 4.0.0
   ...
   * presence of the core-js package because core-js circumvents this kind of
   * detection. Despite multiple requests, the core-js maintainer has made it
   * clear: any attempt to fix the detection will be obstructed. As a result,
   * we're left with little choice but to throw an error. Unfortunately, this
   * also affects packages, like
   * [babel-polyfill](https://www.npmjs.com/package/babel-polyfill), which rely
   * on core-js.
   *
   * @static
   * @memberOf _
   ...
   * @category Lang
   * @param {*} value The value to check.
   * @returns {boolean} Returns `true` if `value` is a safe integer, else
   *     `false`.
   * @example
   *
   * _.isSafeInteger(3);
   ...
   * // => false
   */
  const lte = createRelationalOperation(function(
      value, other) { return value <= other; });
  ...
  function toSafeInteger(value) {
    return value ? baseClamp(toInteger(value), -MAX_SAFE_INTEGER,
                             MAX_SAFE_INTEGER)
                 : value === 0 ? value : 0;
  }
   ...
   * // => { 'a': 1, 'b': 2, 'c': 3, 'd': 4 }
   */
  const assignIn = createAssigner(function(
      object, source) { copyObject(source, keysIn(source), object); });
   ...
   * // => { 'a': 1, 'b': 2 }
   */
  const assignInWith = createAssigner(function(
      object, source, srcIndex,
      customizer) { copyObject(source, keysIn(source), object, customizer); });
   ...
   * // => { 'a': 1, 'b': 2 }
   */
  const assignWith = createAssigner(function(
      object, source, srcIndex,
      customizer) { copyObject(source, keys(source), object, customizer); });
  ...
  const defaults = baseRest(function(object, sources) {
    ...
    while (++index < length) {
      ...
      while (++propsIndex < propsLength) {
        ...
        if (value === undefined || (eq(value, objectProto[key]) &&
   ...
   * @param {Object} object The object to query.
   * @param {Array|string} path The path of the property to get.
   * @param {*} [defaultValue] The value returned for `undefined` resolved
   *     values.
   * @returns {*} Returns the resolved value.
   * @example
   *
   ...
   * // => { 'a': [{ 'b': 2, 'c': 3 }, { 'd': 4, 'e': 5 }] }
   */
  const merge = createAssigner(function(
      object, source, srcIndex) { baseMerge(object, source, srcIndex); });
  ...
  var mergeWith = createAssigner(function(
      object, source, srcIndex,
      customizer) { baseMerge(object, source, srcIndex, customizer); });

  /**
   * The opposite of `_.pick`; this method creates an object composed of the
   * own and inherited enumerable property paths of `object` that are not
   * omitted.
   *
   ...
   * // => { 'a': 1, 'c': 3 }
   */
  const pick = flatRest(function(
      object, paths) { return object == null ? {} : basePick(object, paths); });
  ...
  function pickBy(object, predicate) {
    ...
    const props =
        arrayMap(getAllKeysIn(object), function(prop) { return [ prop ]; });
    predicate = getIteratee(predicate);
    return basePickBy(
        object, props,
        function(value, path) { return predicate(value, path[0]); });
  }
   ...
   * `undefined` path creation is handled by the method instead. The
  ...
  function transform(object, iteratee, accumulator) {
    ...
    (isArrLike ? arrayEach : baseForOwn)(
        ...
        function(
            value, index,
            object) { return iteratee(accumulator, value, index, object); });
    return accumulator;
  }
   ...
   * value to set. Use `_.updateWith` to customize `path` creation. The
   ...
   * // => 'foo-bar'
   */
  const kebabCase = createCompounder(function(
      result, word,
      index) { return result + (index ? "-" : "") + word.toLowerCase(); });
   ...
   * // => 'foo bar'
   */
  const lowerCase = createCompounder(function(
      result, word,
      index) { return result + (index ? " " : "") + word.toLowerCase(); });
  ...
  function pad(string, length, chars) {
    ...
    return (createPadding(nativeFloor(mid), chars) + string +
  ...
  function parseInt(string, radix, guard) {
    ...
    return nativeParseInt(toString(string).replace(reTrimStart, ""),
                          radix || 0);
  }
   ...
   * // => 'foo_bar'
   */
  const snakeCase = createCompounder(function(
      result, word,
      index) { return result + (index ? "_" : "") + word.toLowerCase(); });
   ...
   * // => 'FOO BAR'
   */
  const startCase = createCompounder(function(
      result, word,
   ...
   * var compiled = _.template('<% _.forEach(users, function(user) { %><li><%-
   * user %></li><% }); %>'); compiled({ 'users': ['fred', 'barney'] });
   ...
   * '/basic/greeting.jst' }); compiled(data);
   * // => Find the source of "greeting.jst" under the Sources tab or Resources
   * panel of the web inspector.
   *
   * // Use the `variable` option to ensure a with-statement isn't used in the
   * compiled template. var compiled = _.template('hi <%= data.user %>!', {
   * 'variable': 'data' }); compiled.source;
   * // => function(data) {
   * //   var __t, __p = '';
  ...
  function template(string, options, guard) {
    ...
    const imports = assignInWith({}, options.imports, settings.imports,
   ...
   * @param {string} [options.omission='...'] The string to indicate text is
   *     omitted.
  ...
  function truncate(string, options) {
    ...
    let result = strSymbols ? castSlice(strSymbols, 0, end).join("")
                            : string.slice(0, end);
    ...
    if (isRegExp(separator)) {
      if (string.slice(end).search(separator)) {
        ...
        if (!separator.global) {
          separator =
              RegExp(separator.source, toString(reFlags.exec(separator)) + "g");
        }
   ...
   * // => 'FOO BAR'
   */
  const upperCase = createCompounder(function(
      result, word,
      index) { return result + (index ? " " : "") + word.toUpperCase(); });
  ...
  const method = baseRest(function(path, args) {
    return function(object) { return baseInvoke(object, path, args); };
  });
  ...
  const methodOf = baseRest(function(object, args) {
    return function(path) { return baseInvoke(object, path, args); };
  });
  ...
  function nthArg(n) {
    n = toInteger(n);
    return baseRest(function(args) { return baseNth(args, n); });
  }
  ...
  function propertyOf(object) {
    return function(
        path) { return object == null ? undefined : baseGet(object, path); };
  }
   ...
   * specified, it's set to `start` with `start` then set to `0`.
   *
   * **Note:** JavaScript follows the IEEE-754 standard for resolving
   * floating-point values which can produce unexpected results.
   *
   ...
   */
  const add =
      createMathOperation(function(augend, addend) { return augend + addend; },
                          0);
  ...
  const divide = createMathOperation(
      function(dividend, divisor) { return dividend / divisor; }, 1);
  ...
  const multiply = createMathOperation(
      function(multiplier, multiplicand) { return multiplier * multiplicand; },
      1);
  ...
  const subtract = createMathOperation(
      function(minuend, subtrahend) { return minuend - subtrahend; }, 0);
  ...
  arrayEach(
      ...
      function(methodName) { lodash[methodName].placeholder = lodash; });
  ...
  arrayEach([ "drop", "take" ], function(methodName, index) {
    ...
    LazyWrapper.prototype[methodName + "Right"] = function(
        n) { return this.reverse()[methodName](n).reverse(); };
  });
  ...
  arrayEach([ "head", "last" ], function(methodName, index) {
    ...
    LazyWrapper.prototype[methodName] =
        function() { return this[takeName](1).value()[0]; };
  });
  ...
  LazyWrapper.prototype.find = function(
      predicate) { return this.filter(predicate).head(); };

  LazyWrapper.prototype.findLast = function(
      predicate) { return this.reverse().find(predicate); };
  ...
  LazyWrapper.prototype.reject = function(
      predicate) { return this.filter(negate(getIteratee(predicate))); };
  ...
  LazyWrapper.prototype.takeRightWhile = function(
      predicate) { return this.reverse().takeWhile(predicate).reverse(); };

  LazyWrapper.prototype.toArray =
      function() { return this.take(MAX_ARRAY_LENGTH); };
  ...
  baseForOwn(LazyWrapper.prototype, function(func, methodName) {
    ...
    const lodashFunc =
        lodash[isTaker ? "take" + (methodName == "last" ? "Right" : "")
                       : methodName];
    ...
    lodash.prototype[methodName] = function() {
      ...
      if (useLazy && checkIteratee && typeof iteratee === "function" &&
          iteratee.length != 1) {
      ...
      function(methodName) {
        ...
        lodash.prototype[methodName] = function() {
          ...
          return this[chainName](function(
              value) { return func.apply(isArray(value) ? value : [], args); });
        };
      });
