          ...
          return (
            ...
            (g = a[j][b] = function (a, b) {
              return this._createWidget
                ? (arguments.length && this._createWidget(a, b), void 0)
                : new g(a, b);
            }),
            a.extend(g, f, {
              version: d.version,
      ...
      a.extend(a.mobile, { browser: {} }),
        ...
        a.extend(a.support, {
          cssTransitions:
            ...
            (f("transition", "height 100ms linear", ["Webkit", "Moz", ""]) &&
      ...
      a.each(
        ...
        (a.event.special.swipe = {
          ...
          handleSwipe: function (c, d, e, f) {
            if (
              d.time - c.time < a.event.special.swipe.durationThreshold &&
              ...
              return (
                b(
                  e,
                  "swipe",
                  a.Event("swipe", { target: f, swipestart: c, swipestop: d })
                ),
                b(e, g, a.Event(g, { target: f, swipestart: c, swipestop: d })),
                !0
              );
            }
            return !1;
          ...
          setup: function () {
            ...
            c.bind(g, function (d) {
              function e(c) {
                g &&
                  ((f = a.event.special.swipe.stop(c)),
          ...
          a.event.special.orientationchange,
          {
            setup: function () {
              return a.support.orientation &&
                ...
                ? !1
                : ((f = e()), l.bind("throttledresize", d), void 0);
            },
            teardown: function () {
              return a.support.orientation &&
                !a.event.special.orientationchange.disabled
      ...
      (a.widget = (function (c) {
        ...
        a.widget("mobile.page", {
          ...
          _setOptions: function (c) {
            c.theme !== b &&
              this.element
                .removeClass("ui-body-" + this.options.theme)
      ...
      a.widget("mobile.pagecontainer", {
        ...
        _handleNavigate: function (b, c) {
          ...
          a.extend(h, c, { transition: (f.getLast() || {}).transition || g }),
            (f.activeIndex > 0 &&
              e.indexOf(a.mobile.dialogHashKey) > -1 &&
              f.initialDst !== e &&
                  ...
                  : ((h = {
                    ...
                    g.event.isDefaultPrevented()
                      ...
                      : (j.showLoadMsg && this._showLoading(j.loadMsgDelay),
                        ...
                        a.mobile.allowCrossDomainPages ||
                        a.mobile.path.isSameDomain(a.mobile.path.documentUrl, l)
                          ? (a.ajax({
                              url: e,
                              type: j.type,
                              data: j.data,
      ...
      (a.mobile.loadPage = function (b, c) {
        ...
        (a.mobile._registerInternalEvents = function () {
          var e = function (b, c) {
            ...
            return !a.mobile.ajaxEnabled ||
              ...
              : ((d = (g && g.attr("formaction")) || b.attr("action")),
                ...
                !a.mobile.path.isPermittedCrossDomainRequest(f, d)
                  ? !1
                  : (c ||
                      ((e = b.serializeArray()),
                      g &&
          ...
          a.mobile.document.delegate("form", "submit", function (b) {
            ...
            b.isDefaultPrevented() ||
              ((c = e(a(this))),
              c && (a.mobile.changePage(c.url, c.options), b.preventDefault()));
          }),
              ...
              if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                if (((g = a(h)), a.data(h, "mobile-button"))) {
                  ...
                  if (
                    ...
                    !h ||
                      "#" ===
                        a.mobile.path.parseUrl(h.getAttribute("href") || "#")
                          .hash)
                  )
                    return;
                ...
                ~h.className.indexOf("ui-link-inherit")
                  ? h.parentNode && (f = a.data(h.parentNode, "buttonElements"))
                ...
                if (
                  ...
                  if (-1 !== h.search("#")) {
                    ...
                    h = a.mobile.path.isPath(h)
                      ...
                      : a.mobile.path.makeUrlAbsolute("#" + h, f.hrefNoHash);
                  }
                  if (
                    ((i =
                      o.is("[rel='external']") ||
                    ...
                    (j =
                      ...
                      (a.mobile.path.isExternal(h) &&
                        !a.mobile.path.isPermittedCrossDomainRequest(f, h))))
                  )
                    return p(), void 0;
    ...
    (function (a, b) {
      ...
      a.widget("mobile.collapsible", {
        ...
        _create: function () {
          ...
          a.extend(this, { _ui: c }),
            this.options.enhanced
              ? ((c.heading = a(".ui-collapsible-heading", this.element[0])),
        ...
        _enhance: function (b, c) {
          ...
          return (
            ...
            (c.content = b
              .wrapInner("<div class='ui-collapsible-content " + f + "'></div>")
            ...
            (d = e.collapsed
              ? e.collapsedIcon
                ? "ui-icon-" + e.collapsedIcon
                : ""
              : e.expandedIcon
              ? "ui-icon-" + e.expandedIcon
              : ""),
            (c.status = a(
        ...
        _setOptions: function (a) {
          ...
          a.collapsed !== b && this._handleExpandCollapse(a.collapsed),
            ...
            c
              ? (l.expandCueText !== b && k.text(l.expandCueText),
                l.collapsedIcon !== b &&
                  (h.collapsedIcon &&
                    j.removeClass("ui-icon-" + h.collapsedIcon),
                  l.collapsedIcon && j.addClass("ui-icon-" + l.collapsedIcon)))
              : (l.collapseCueText !== b && k.text(l.collapseCueText),
                l.expandedIcon !== b &&
                  (h.expandedIcon && j.removeClass("ui-icon-" + h.expandedIcon),
                  l.expandedIcon && j.addClass("ui-icon-" + l.expandedIcon))),
            l.iconpos !== b &&
              (j.removeClass(
                "ui-btn-icon-" + ("right" === h.iconPos ? "right" : "left")
              ),
              j.addClass(
                "ui-btn-icon-" + ("right" === l.iconPos ? "right" : "left")
              )),
            l.theme !== b &&
        ...
        a.extend(
          {
              ...
              var b = this.element,
                ...
                f = e.length
                  ...
                  : b
                      ...
                      .find("label")
                      .filter(
                        "[for='" + a.mobile.path.hashToSelector(b[0].id) + "']"
                      )
                      .first(),
                g = b[0].type,
                h = "ui-" + g + "-on",
            ...
            refresh: function () {
              ...
              b ? (g.push(d), f.push(e)) : (g.push(e), (c ? f : g).push(d)),
                c
                  ? (f.push(this.checkedClass), g.push(this.uncheckedClass))
          ...
          return v.nativeMenu
            ...
            : ((u = this),
              ...
              (j = v.theme
                ...
                : ""),
              (k = v.overlayTheme
                ? " data-" + a.mobile.ns + "theme='" + v.overlayTheme + "'"
                : ""),
              (l =
                v.dividerTheme && h
                  ? " data-" +
                ...
                function (b) {
                  ...
                  (e.selected = u.isMultiple ? !e.selected : !0),
                    u.isMultiple &&
                      a(this)
                        .find("a")
                        .toggleClass("ui-checkbox-on", e.selected)
                        .toggleClass("ui-checkbox-off", !e.selected),
      ...
      a.widget("mobile.toolbar", {
        ...
        _addHeaderButtonClasses: function () {
          ...
          (this.leftbtn = a.hasClass("ui-btn-left")),
            ...
            (this.leftbtn =
              this.leftbtn ||
              a.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length),
            (this.rightbtn =
                ...
                ? (m.ct
                  ...
                  d ||
                    ...
                    (h = m.bg
                      .removeAttr("style")
                      .css(
                        "cx" === g[e.dir].dimKey ? "width" : "height",
    ...
    (function (a, c) {
      a.widget("mobile.panel", {
        ...
        _handleClick: function (b) {
          if (
            b.currentTarget.href.split("#")[1] === this._panelID &&
            this._panelID !== c
          ) {
            b.preventDefault();
            var d = a(b.target);
        ...
        _menuInputChange: function (b) {
          ...
          c
            ...
            c[0].getAttribute("locked")
              ? (c.removeAttr("locked"), this._unlockCells(c.jqmData("cells")))
              : c.attr("locked", !0);
        },
    ...
    (function (a, c) {
      ...
      a.widget("mobile.filterable", {
        ...
        _filterItems: function (b) {
          ...
          0 === i.length
            ? k[j.filterReveal ? "addClass" : "removeClass"]("ui-screen-hidden")
            ...
            initializePage: function () {
              ...
              e.length ||
                ...
                e.each(function () {
                  ...
                  b[0].getAttribute("data-" + a.mobile.ns + "url") ||
                    b.attr(
                      ...
                      b.attr("id") || location.pathname + location.search
                    );
                }),
                ...
                (a(h).is(":jqmData(role='page')") ||
                  ...
                  : (a.mobile.path.isHashValid(location.hash) &&
                      (a.mobile.navigate.history.initialDst = g.replace(
                        "#",
                        ""
                      )),
                    a.event.special.navigate.isPushStateEnabled() &&
