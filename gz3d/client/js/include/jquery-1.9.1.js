...
(function (window, undefined) {
  ...
  const rboolean = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i;
  ...
  (function (window, undefined) {
    ...
    function setMatcher(
      ...
      return markFunction(function (seed, results, context, xml) {
        ...
        let matcherOut = matcher // If we have a postFinder, or filtered seed, or non-seed
